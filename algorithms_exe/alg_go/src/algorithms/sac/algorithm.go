...
func SAC(function testfunc.TestFunction, options Options) (fBest float64, xBest, bestChart, meanChart, nuclearFunc, dispersion []float64, coordinates [][]float64, numberMeasurements, stopIter int) {
