...
class NoiseResistanceGSA(GSA):
    """
    Алгоритм гравитационного поиска модифицированный для лучшей работы 
    в условиях воздействия помех.
    Noise Resistance Gravitation Search Algorithm (NR-GSA).
    Алгритм имеет следующие настраеваемые параметры:
        - максимальное количество итерций
        - начальное количество точек
        - коэффициент шум/сигнал
        - индекс функции изменения гравитационной постоянной
        - начальное значение гравитационной постоянной
        - alpha
        - флаг использование элитных зондов, 0 - нет, 1 - да
        - норма линейного пространства, 2 - евклидово расстояние
        - степень влияния расстояния на силу гравитации
        - gamma
        - коэффициент селективности (s)
        - индекс ядерной функции
        - q
        - конечное количество точек
        - индекс закона изменения количества точек
    """
    def __init__(self):
        super().__init__()
