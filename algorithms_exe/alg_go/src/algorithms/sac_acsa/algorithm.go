...
func NewSAC(function testfunc.TestFunction, options Options) (fBest float64, xBest, bestChart, meanChart, nuclearFunc []float64, dispersion [][]float64, numberMeasurements, stopIter int) {
...
func RunSACAcsa(function testfunc.TestFunction, options algorithms.OptionsAlgorithm) (float64, []float64, []float64, interface{}, int, int) {
	op := options.(*Options)
	fBest, xBest, bestChart, _, _, dispersion, numberMeasurements, stopIteration := NewSAC(function, *op)
